  ...
  void _signInStudent() {
    if (_grNumberTextEditingController.text.trim().isEmpty) {
      Utils.showCustomSnackBar(
        context: context,
        errorMessage: Utils.getTranslatedLabel(context, pleaseEnterGRNumberKey),
    ...
    if (_passwordTextEditingController.text.trim().isEmpty) {
      Utils.showCustomSnackBar(
        context: context,
        errorMessage: Utils.getTranslatedLabel(context, pleaseEnterPasswordKey),
        backgroundColor: Theme.of(context).colorScheme.error,
      );
      return;
    }
    ...
    return Align(
      ...
      child: Padding(
        ...
        child: GestureDetector(
          ...
          child: Text(
            "${Utils.getTranslatedLabel(context, resetPasswordKey)}?",
          ...
          child: NotificationListener(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    Utils.getTranslatedLabel(context, letsSignInKey),
                    style: TextStyle(
                      fontSize: 34.0,
                    ...
                    child: BlocConsumer<SignInCubit, SignInState>(
                      ...
                      builder: (context, state) {
                        return CustomRoundedButton(
                          ...
                          buttonTitle:
                              Utils.getTranslatedLabel(context, signInKey),
